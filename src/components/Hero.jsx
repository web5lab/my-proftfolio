			...
			>
				...
				<div>
					<h1 className={`${styles.heroHeadText} text-white relative z-10`}>
						Hi, I'm <span className='text-clr_blue'>Shiva</span>
					</h1>
					<p
						className={`${styles.heroSubText} relative z-10 mt-2 text-white-100 md:max-w-[640px] max-w-[460px] `}
					>
						I'm a talented Full Stack Blockchain Developer with expertise in both front-end and back-end
  development.<br/> My skills extend to building decentralized applications and integrating blockchain
  technology to deliver secure, scalable solutions.
					</p>
				</div>
			</div>
